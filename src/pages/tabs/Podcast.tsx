...
export default function Podcast() {
  ...
  return (
    <div className="min-h-[calc(100vh-7rem)] relative">
      <SEO title="Podcast studio · Storyou" description="Draft podcast episodes from your stories — intros, segments, outros, and show notes ready to record." path="/podcast" />
