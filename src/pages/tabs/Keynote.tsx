...
export default function Keynote() {
  ...
  return (
    <div className="min-h-[calc(100vh-7rem)]">
      <SEO title="Keynote builder · Storyou" description="Turn your stories into stage-ready keynotes. Get AI feedback from a coach calibrated to CEOs, public speakers, storytellers, and communicators." path="/keynote" />
